...
| VERIFICATION_ACTIVE_SESSIONS_BUFFER_SIZE          | Maximum active verification sessions. When exceeded, sessions waiting for an earlier block are evicted, backfilled first.       |                                      100 |
