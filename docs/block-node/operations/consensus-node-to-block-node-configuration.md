...
| `streamingPort`             | integer | Yes      | TCP port the Block Node listens on for incoming block streams. LFH profile default: `40984` (`PORTS_PUBLISHER`). Base-chart default: `40840`.                            |
