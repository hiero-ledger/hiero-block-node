...
public class TestBlocks {
    ...
    public static final byte[] V2_TEST_BLOCK_HASH = HexFormat.of().parseHex(
    ...
    static {
        try {
            V2_TEST_BLOCK_BYTES = Objects.requireNonNull(ParsedV2RecordFileTest.class.getResourceAsStream(
                "/record-files/example-v2/"+V2_TEST_BLOCK_DATE_STR+"/"+V2_TEST_BLOCK_RECORD_FILE_NAME)).readAllBytes();
        } catch (IOException e) {
    ...
    public static final byte[] V5_TEST_BLOCK_HASH = HexFormat.of().parseHex(
    ...
    static {
        try {
            V5_TEST_BLOCK_ADDRESS_BOOK = NodeAddressBook.PROTOBUF.parse(Bytes.wrap(Objects.requireNonNull(
                ParsedV2RecordFileTest.class.getResourceAsStream(
                    "/record-files/example-v5/"+V5_TEST_BLOCK_DATE_STR+"/address_book.bin")).readAllBytes()));
            V5_TEST_BLOCK_BYTES = Objects.requireNonNull(ParsedV2RecordFileTest.class.getResourceAsStream(
                "/record-files/example-v5/"+V5_TEST_BLOCK_DATE_STR+"/"+V5_TEST_BLOCK_RECORD_FILE_NAME)).readAllBytes();
    ...
    public static final byte[] V6_TEST_BLOCK_HASH = HexFormat.of().parseHex(
    ...
    static {
        try {
            V6_TEST_BLOCK_ADDRESS_BOOK = NodeAddressBook.PROTOBUF.parse(Bytes.wrap(Objects.requireNonNull(
                ParsedV2RecordFileTest.class.getResourceAsStream(
                    "/record-files/example-v6/"+V6_TEST_BLOCK_DATE_STR+"/address_book.bin")).readAllBytes()));
            V6_TEST_BLOCK_BYTES = Objects.requireNonNull(ParsedV2RecordFileTest.class.getResourceAsStream(
                "/record-files/example-v6/"+V6_TEST_BLOCK_DATE_STR+"/"+V6_TEST_BLOCK_RECORD_FILE_NAME)).readAllBytes();
        } catch (IOException | ParseException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        long blockNum = blockTimeReader.getNearestBlockAfterTime(instantToBlockTimeLong(
            Instant.parse("2025-07-23T20:37:42.076472454Z")));
