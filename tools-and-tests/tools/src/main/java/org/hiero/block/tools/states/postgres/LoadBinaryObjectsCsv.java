...
//                System.out.println("      Computed Hash matches: " + binaryObject.hexHash().equals(binaryObject.computeHexHash()));
...
//                    }
//                    case FILE_DATA -> {
//                        System.out.println("      File Contents: " + dumpBinaryData(binaryObject.fileContents()));
//                    }
...
//        dumpSystemFiles(storageMap, binaryObjectByHexHashMap);
    ...
    public static String KNOWN_HEX_FOR_13707 = "";


    public static void dumpSystemFiles(FCMap<StorageKey, StorageValue> storageMap,
        ...
        BinaryObjectCsvRow feeFileBinObj = binaryObjectByHexHashMap.get(feeFileStorageValue.data().hash().hex());
        CurrentAndNextFeeSchedule currentAndNextFeeSchedule = CurrentAndNextFeeSchedule.PROTOBUF.parse(Bytes.wrap(feeFileBinObj.fileContents()));
...
//        System.out.println(CurrentAndNextFeeSchedule.JSON.toJSON(currentAndNextFeeSchedule));
        ...
        BinaryObjectCsvRow nodeAddressBookBinObj = binaryObjectByHexHashMap.get(nodeAddressBookStorageValue.data().hash().hex());
        NodeAddressBook nodeAddressBook = NodeAddressBook.PROTOBUF.parse(Bytes.wrap(nodeAddressBookBinObj.fileContents()));
        System.out.println("=== nodeAddressBook ====");
        nodeAddressBook.nodeAddress().forEach(nodeAddress -> {
            System.out.println("    Node ID: " + nodeAddress.nodeId() +
                    ", IP: " + nodeAddress.ipAddress().asUtf8String() +
                    ", Port: " + nodeAddress.portno() +
                    ", Memo: " + nodeAddress.memo().asUtf8String() );
        });
        // ExchangeRateSet
        var exchangeRateStorageValue = storageMap.get(new StorageKey("/0/f"+EXCHANGE_RATE_FILE_ACCOUNT_NUM));
        BinaryObjectCsvRow exchangeRateBinObj = binaryObjectByHexHashMap.get(exchangeRateStorageValue.data().hash().hex());
        ...
        BinaryObjectCsvRow nodeDetailsBinObj = binaryObjectByHexHashMap.get(nodeDetailsStorageValue.data().hash().hex());
        ...
        nodeDetails.nodeAddress().forEach(nodeAddress -> {
            System.out.println("    Memo: " + nodeAddress.memo().asUtf8String() +
                    ", rsaPubKey : " + nodeAddress.rsaPubKey()
            );
        });
