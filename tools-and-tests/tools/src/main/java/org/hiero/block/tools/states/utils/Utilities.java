...
public class Utilities extends DataStreamUtils {
    ...
    public static void writeInstant(FCDataOutputStream stream, Instant instant) throws IOException {
     ...
     * 		thrown if there are any problems during the operation
     */
    public static Instant readInstant(FCDataInputStream stream) throws IOException {
     ...
     * 		thrown if there are any problems during the operation
     */
    public static void writeIntArray(DataOutputStream stream, int[] data) throws IOException {
     ...
     * 		thrown if there are any problems during the operation
     */
    public static void writeLongArray(DataOutputStream stream, long[] data) throws IOException {
        int len = (data == null ? 0 : data.length);
        stream.writeInt(len);
        for (int i = 0; i < len; i++) {
     ...
     * 		thrown if there are any problems during the operation
     */
    public static long[] readLongArray(DataInputStream stream) throws IOException {
        int len = stream.readInt();
     ...
     * 		thrown if there are any problems during the operation
     */
    public static long[][] readLongArray2D(FCDataInputStream stream) throws IOException {
        int len = stream.readInt();
        long[][] data = new long[len][];
        for (int i = 0; i < len; i++) {
     ...
     * 		thrown if there are any problems during the operation
     */
    public static String[] readStringArray(FCDataInputStream stream) throws IOException {
        int len = stream.readInt();
    ...
    public static <T extends Record> List<T> readFastCopyableArray(
            FCDataInputStream stream, DeserializeFunction<T> deserializeFunction) throws IOException {
        int len = stream.readInt();
     ...
     * 		thrown if there are any problems during the operation
     */
    public static Color[] readColorArray(FCDataInputStream stream) throws IOException {
        int len = stream.readInt();
    ...
    public static <T> List<T> readList(
            FCDataInputStream stream, Supplier<List<T>> listSupplier, Deserializer<T> deserializer) throws IOException {
    ...
    static byte[] intToBytes(int i) {
        return new byte[] {(byte) i, (byte) (i >> 8), (byte) (i >> 16), (byte) (i)};
    }
