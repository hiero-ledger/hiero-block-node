...
# does not currently expose a histogram metric for true p99 — see
# agent/proposals/solo-chaos-spike/findings/004-bn-lacks-histogram-metrics-for-block-arrival.md
