...
# bn_server_status to serve pre-recorded fixtures.
...
function bn_server_status { echo '{"firstAvailableBlock":"0","lastAvailableBlock":"1872"}'; }
...
function bn_server_status { echo '{"firstAvailableBlock":"0","lastAvailableBlock":"1842"}'; }
if ! assert_mirror_lag_single "mirror-1" "30" >/dev/null 2>&1; then
...
function fetch_mn_latest_block { echo "1842"; }
function bn_server_status { echo '{}'; }
if ! assert_mirror_lag_single "mirror-1" "30" >/dev/null 2>&1; then
