...
| `SOLO_VERSION`           | `latest`                 | Solo CLI version (CI pins to `0.59.1`)                               |
...
| `solo-version`             | `0.59.1`                 | Solo CLI version                                     |
...
| Solo CLI errors                    | Version mismatch     | `npm i @hashgraph/solo@0.59.1 -g`             |
