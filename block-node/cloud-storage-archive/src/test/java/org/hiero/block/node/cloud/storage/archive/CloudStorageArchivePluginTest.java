...
class CloudStorageArchivePluginTest {
    ...
    final class RecoveryIntegrationTests
        ...
        public void addBlockRange(LongRange blockRange, BlockRangeType blockRangeType) {
            super.addBlockRange(blockRange, blockRangeType);
        ...
        /// [ApplicationStateFacility#addBlockRange] when S3 is empty (fresh start).
        @Test
        ...
        /// [ApplicationStateFacility#addBlockRange] with the full range of the last completed group
        ...
        void completedTarRecoveryCallsAddBlockRange() throws Exception {
            ...
            assertThat(capturedTypes).containsExactly(BlockRangeType.STORED);
        }

        /// Verifies that [CloudStorageArchivePlugin#completeRecovery] calls
        /// [ApplicationStateFacility#addBlockRange] up to the last clean boundary found in the
