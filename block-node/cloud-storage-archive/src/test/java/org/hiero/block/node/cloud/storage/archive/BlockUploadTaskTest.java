...
class BlockUploadTaskTest {
    ...
    /// Verifies that [ApplicationStateFacility#addStoredBlockRange] is called exactly once
    /// covering all blocks when the upload fits in a single final part.
    @Test
    ...
    /// Verifies that [ApplicationStateFacility#addStoredBlockRange] is called once per flushed part
    ...
    /// Verifies that [ApplicationStateFacility#addStoredBlockRange] is never called when the upload fails.
    @Test
