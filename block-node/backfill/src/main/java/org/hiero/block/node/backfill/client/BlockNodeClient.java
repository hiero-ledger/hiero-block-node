...
public class BlockNodeClient {
    ...
    // Use 8MB to match server.http2.maxFrameSize default and handle larger blocks
    private static final int DEFAULT_8MB = 8 * 1024 * 1024;
    ...
    private static final IntConfigSpec MAX_FRAME_SIZE = new IntConfigSpec(
            "maxFrameSize", DEFAULT_8MB, HTTP2_MIN_FRAME_SIZE, HTTP2_MAX_FRAME_SIZE, GrpcWebClientTuning::maxFrameSize);
    private static final IntConfigSpec INITIAL_WINDOW_SIZE = new IntConfigSpec(
            "initialWindowSize", DEFAULT_8MB, 1, HTTP2_MAX_WINDOW_SIZE, GrpcWebClientTuning::initialWindowSize);
    ...
    private static final IntConfigSpec INITIAL_BUFFER_SIZE = new IntConfigSpec(
            "initialBufferSize", DEFAULT_8MB, MIN_BUFFER_SIZE, MAX_BUFFER_SIZE, GrpcWebClientTuning::initialBufferSize);
