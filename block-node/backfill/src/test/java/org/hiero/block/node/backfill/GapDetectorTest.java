...
class GapDetectorTest {
    ...
    void detectsAndClassifiesGaps() {
        ...
        assertGaps(
                List.of(new LongRange(3, 10)),
                0, 10, 10,
                List.of(gap(0, 2, GapDetector.Type.HISTORICAL)));
        ...
        assertGaps(
                List.of(new LongRange(0, 5)),
                0, 3, 10,
                List.of(gap(6, 10, GapDetector.Type.LIVE_TAIL)));
    ...
    private void assertGaps(List<LongRange> ranges, long start, long boundary, long endCap, List<GapDetector.Gap> expected) {
