...
public record StateManagementConfig(
        ...
        /*
         * Dedicated port the state-management gRPC service (StateService) binds to. When
         * {@code null} (the default) the plugin shares the default {@code server.port}; when
         * set it must be a valid 1024–65535 port. Mirrors the server-status plugin's option.
         */
