...
//
//        // then
//        Mockito.verify(httpRules, Mockito.times(1)).get(ArgumentMatchers.eq(LIVENESS_PATH), ArgumentMatchers.any());
//        Mockito.verify(httpRules, Mockito.times(1)).get(ArgumentMatchers.eq(READINESS_PATH), ArgumentMatchers.any());
