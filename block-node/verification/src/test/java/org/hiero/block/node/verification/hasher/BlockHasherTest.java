...
import org.hiero.block.node.verification.session.VerificationSessionFailedException;
...
class BlockHasherTest {
    private static final String ALL_RESOURCE_BLOCKS_SOURCE =
            "org.hiero.block.node.verification.hasher.BlockHasherTest#allResourceBlocks";
    private static final String ALL_RESOURCE_WRB_BLOCKS_SOURCE =
            "org.hiero.block.node.verification.hasher.BlockHasherTest#allResourceWRBBlocks";
    private static final String ALL_RESOURCE_NON_WRB_BLOCKS_SOURCE =
            "org.hiero.block.node.verification.hasher.BlockHasherTest#allResourceNonWRBBlocks";
    private static final String FOOTER_WITH_MISSING_VALUES =
            "org.hiero.block.node.verification.hasher.BlockHasherTest#footerWithMissingValues";
