...
import org.hiero.block.node.verification.metrics.SessionHandlerMetrics;
import org.hiero.block.node.verification.session.BlockVerificationSession.SessionKey;

/// Handler for [BlockVerificationSession]s.
/// This handler is responsible for creating, managing, and canceling
/// [org.hiero.block.node.verification.verifier.BlockVerificationResult].
