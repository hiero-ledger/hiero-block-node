...
class PublisherHandlerTest {
    ...
    class FunctionalityTest {
        ...
        class OnNextTest {
            ...
            @DisplayName(
                    "Test onNext() with valid request with a complete single block calls closeBlock on manager when batch ends with valid proof - happy path ACCEPT")
            void testPublishItemsNullCloseBlockCallWhenRequestEndsWithBrokenProofHappyPathACCEPT(
            ...
            @Test
            @DisplayName(
                    "Test onNext() with valid request with a complete single block metrics updated - happy path SKIP")
