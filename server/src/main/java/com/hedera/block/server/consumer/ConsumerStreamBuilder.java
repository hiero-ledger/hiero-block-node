...
public final class ConsumerStreamBuilder {
    ...
    public static Runnable build(
        ...
        final ConsumerStreamResponseObserver consumerStreamResponseObserver = new ConsumerStreamResponseObserver(
                producerLivenessClock, helidonConsumerObserver, metricsService, configuration);

        final StreamManager streamManager = new OpenRangeStreamManager(
        ...
        return new ConsumerStreamRunnable(streamManager);
    }
}
